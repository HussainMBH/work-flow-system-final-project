				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<input type="text" name="contact" id="" class="form-control form-control-sm" value="<?php echo isset($contact) ? $contact : '' ?>" required>
						</div>
						<div class="form-group">
	...
	$('#manage_user').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('User Details successfully saved.',"success");
					setTimeout(function(){
